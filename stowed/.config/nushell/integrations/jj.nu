...
(arrange)
_arguments "${_arguments_options[@]}" : \
'*-r+[The revisions to edit]:REVSETS:_default' \
'*--revisions=[The revisions to edit]:REVSETS:_default' \
'-R+[Path to repository to operate on]:REPOSITORY:_files -/' \
'--repository=[Path to repository to operate on]:REPOSITORY:_files -/' \
'--at-operation=[Operation to load the repo at]:AT_OPERATION:_default' \
'--at-op=[Operation to load the repo at]:AT_OPERATION:_default' \
...
'-p+[The glob pattern to search for]:PATTERN:_default' \
'--pattern=[The glob pattern to search for]:PATTERN:_default' \
'-R+[Path to repository to operate on]:REPOSITORY:_files -/' \
'--repository=[Path to repository to operate on]:REPOSITORY:_files -/' \
'--at-operation=[Operation to load the repo at]:AT_OPERATION:_default' \
'--at-op=[Operation to load the repo at]:AT_OPERATION:_default' \
...
'--hashtag=[Applies a hashtag to the change]:HASHTAG:_default' \
...
'*--revisions=[Show tags whose local targets are in the given revisions]:REVSETS:_default' \
...
(( $+functions[_jj__arrange_commands] )) ||
_jj__arrange_commands() {
    local commands; commands=()
...
(( $+functions[_jj__bookmark__advance_commands] )) ||
_jj__bookmark__advance_commands() {
    local commands; commands=()
...
(( $+functions[_jj__debug__stacked-table_commands] )) ||
_jj__debug__stacked-table_commands() {
    local commands; commands=()
...
(( $+functions[_jj__file__search_commands] )) ||
_jj__file__search_commands() {
    local commands; commands=()
...
(( $+functions[_jj__operation__integrate_commands] )) ||
_jj__operation__integrate_commands() {
    local commands; commands=()
...
(( $+functions[_jj__util__snapshot_commands] )) ||
_jj__util__snapshot_commands() {
    local commands; commands=()
