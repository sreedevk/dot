...
SNAP_PATH=/snap/bin
export PATH="$PATH:$YARN_PATH:$CONDA_PATH:$GO_PATH:$DBEAVER_PATH:$KENDRYTE_PATH:$MAIXPY_PATH:$MRUBY_PATH:$DOOM_PATH:$CARGO_PATH:$ASPEN_PATH:$CUSTOM_SCRIPTS_PATH:$SNAP_PATH:$LOCAL_BIN_PATH"
