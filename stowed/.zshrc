...
AWS_SSH_PATH="$HOME/.local/aws-ssh"
CUSTOM_SCRIPTS_PATH=$HOME/.scripts
SNAP_PATH=/snap/bin
RPI0W_TOOLCHAIN_PATH=/opt/rpi0w-toolchain/bin
SURREAL_DB_PATH="$HOME/.surrealdb"
export PATH="$PATH:$YARN_PATH:$CONDA_PATH:$GO_PATH:$DBEAVER_PATH:$KENDRYTE_PATH:$MAIXPY_PATH:$MRUBY_PATH:$DOOM_PATH:$CARGO_PATH:$ASPEN_PATH:$CUSTOM_SCRIPTS_PATH:$SNAP_PATH:$LOCAL_BIN_PATH:$AWS_SSH_PATH:$RPI0W_TOOLCHAIN_PATH:$SURREAL_DB_PATH"
